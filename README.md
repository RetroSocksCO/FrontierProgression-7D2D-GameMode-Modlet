...
* A 7 Days to Die V 2.6 Experimental Modlet.
* Client, Server, and EAC-friendly Modlet.
* All resources used are available in the vanilla client and retain core values.
* Alternative progression route, start the game with all skills maxed or don't. It can be scrapped. (perks and perk books are vanilla progression)
* 2 new recipes for Water and Scrap Polymers.
...
* Utility Zombie: Electrical Parts x1-3
* Hazmat/Party Girl Zombie: Scrap Polymers x1-3
